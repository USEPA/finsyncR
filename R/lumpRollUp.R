...
#'
#' @param inputdataset Input dataset that must be generated from
#'  \code{getInvertData()}.
#'
...
lumpRollUp <- function(inputdataset){
  ...
  if(!("Allenhyphes.Asioplax.Homoleptohyphes.Leptohyphes.Tricorythodes.Vacupernius" %in% colnames(inputdataset))){
    stop("The input dataset must be generated by must be generated getInvertData(taxonFix = 'lump').")
  }
