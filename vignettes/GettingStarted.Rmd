...
The authors, for instance, do not advise users evaluate temporal changes in abundance or richness of the linked groups of Ephemeroptera genera because taxonomic reorganizations over the last decades likely obscure temporal patterns.
...
`taxonFix` operates on the genus level, so `taxonFix` must be set to `"none"` when taxonLevel is set to "Family" or higher taxonomic resolution.
...
## 1   USGS  WHMI BioTDB USGS-393259085101200 393259085101200-A-NAWQA-BioTDB     1999-07-13
## 2   USGS  WHMI BioTDB        USGS-03245500        03245500-A-NAWQA-BioTDB     1999-07-14
## 3   USGS  WHMI BioTDB        USGS-03246400        03246400-A-NAWQA-BioTDB     1999-07-15
## 4   USGS  WHMI BioTDB USGS-395534084091400 395534084091400-A-NAWQA-BioTDB     1999-07-07
## 5   USGS  WHMI BioTDB USGS-395650083504400 395650083504400-A-NAWQA-BioTDB     1999-07-06
## 6   USGS  WHMI BioTDB USGS-392246084340100 392246084340100-A-NAWQA-BioTDB     1999-07-13
...
##   StreamOrder WettedWidth PredictedWettedWidth_m NARS_Ecoregion SampleTypeCode AreaSampTot_m2
## 1           4          NA                  27.88            SAP           IRTH           1.25
## 2           5          NA                  43.55            TPL           IRTH           1.25
## 3           4          NA                     NA            TPL           IRTH           1.25
## 4           5          NA                  46.70            TPL           IRTH           1.25
## 5           5          NA                  28.50            TPL           IRTH           1.25
## 6           7          NA                 100.42            TPL           IRTH           1.25
##   FieldSplitRatio LabSubsamplingRatio PropID Gen_ID_Prop
## 1               1              0.0170 0.0170   0.8838527
## 2               1              0.0347 0.0347   0.8655914
## 3               1              0.0397 0.0397   0.8084416
## 4               1              0.0149 0.0149   0.7481297
## 5               1              0.0298 0.0298   0.7476923
## 6               1              0.0113 0.0113   0.8468208
...
## ℹ In argument: `tax_No fish = ifelse(`tax_No fish` == 0, "Fish Collected", "No Fish
##   Collected")`.
...
```
##      SiteNumber CollectionYear PCTURBMD_Cat PCTMXFST_Cat PCTHAY_Cat PCTURBLO_Cat PCTSHRB_Cat
## 1 USGS-05276005           2005         0.25         1.02      41.31         3.84           0
## 2 USGS-05276005           2007         0.35         1.02      41.48         3.84           0
## 3 USGS-05276005           2009         0.46         1.02      41.48         3.91           0
##   PCTURBHI_Cat PCTHBWET_Cat PCTCROP_Cat PCTGRS_Cat PCTOW_Cat PCTBL_Cat PCTCONIF_Cat PCTDECID_Cat
## 1         0.11         2.81       38.56          0         0         0            0         0.46
## 2         0.11         2.64       38.56          0         0         0            0         0.46
## 3         0.11         2.50       38.56          0         0         0            0         0.46
