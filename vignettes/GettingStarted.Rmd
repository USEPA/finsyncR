...
In this Getting Started Vignette, we discuss these barriers and strategies to overcome them, so users can make informed decisions about the data given their specific research questions.
...
Density values are standardized abundances (number of organisms per m^2^) and occurrence values are presence (1) or absence (0).
...
`boatableStreams` provides the option to include data from large streams and rivers that are too deep to be sampled by wading.
All USGS sampling locations are considered wadeable streams, while EPA samples both wadeable streams and boatable rivers.
As such, `boatableStreams` should only be `TRUE` when `agency` is set to `"EPA"` only, to ensure the highest comparability between the two agency datasets. `boatableStreams` should be `FALSE` when users want to include WSA (EPA samples from 2000-2004) in analyses.
...
The rarefaction level defaults to 300 individuals, `rarefyCount = 300`, to balance the proportion of the samples dropped that failed to meet the rarefaction level with the addition of genera gained at the rarefaction level ([Figure 5](#Figure5)). All samples with <300 individuals sampled are removed from the output dataset.
...
Similarly, within some orders within the EPA dataset, `Gen_ID_Prop` decreases over time. One possible explanation for these trends could be the time spent identificating and enumerating WSA samples was greater than NRSA samples, and as a result the probability of detection of these groups could appear to decrease through time ([Figure 8](#Figure8)).
Users should take care to consider these patterns since they could lead to the false impression that genera appear and disapear through time.
...
Fish species names output by the function are unified and current, meaning that species that may have had multiple, synonymous names in the raw datasets have been combined and have been replaced with the current scientific name.
...
Finally, `boatableStreams` provides the option to include data from large streams and rivers that are too deep to sample by wading. Most USGS sampling locations are considered wadeable streams, while EPA samples both wadeable streams and boatable streams and rivers. Thus, set `boatableStreams` to `TRUE` when `agency` is set to "`EPA`" only, to ensure the highest comparability between the two agency datasets.
...
In contrast, watersheds are larger than catchments and include land that drains directly to the stream segment from the surrounding uplands, plus all upstream contributions from flow-connected stream segments. See [StreamCat](https://www.epa.gov/national-aquatic-resource-surveys/streamcat-dataset) documentation for more information.
...
```
## Error in dplyr::select(., SiteNumber, CollectionYear): object 'Fish' not found
```
...
```
## Error in dplyr::left_join(data, (.allsitesCOMID[, -c(3, 4, 5)] %>% dplyr::filter(SiteNumber %in% : object 'Fish_forNLCD' not found
```
...
We are especially grateful to Sarah Lehmann, Richard Mitchell, Amanda Nahlik, Dave Peck, and Alan Herlihy at EPA, and Travis Schmidt, Scott Grotheer, Robert Zuellig, and Peter Ruhl at USGS for the intellectual support of this work and the many conversations about the nuances of these data.
...
<br>
<a id="TableA1"></a>
**Table A1.** Table linking genus numbers from [Figure 1](#Figure1) to genera names, the number of samples in each agency in which the genera were found, and associated genus cluster.

| Genus Number |            Genus | EPA Samples | USGS Samples | Group                                                                                                                                                                                                              |
|-----------------:|-----------------:|-----------------:|-----------------:|:-----------------------------------|
|            1 | Acentrella | 1108 | 1269 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            2 | Acerpenna | 651 | 283 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            4 | Amercaenis | 51 | 38 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            5 | Americabaetis | 0 | 4 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            6 | Anafroptilum | 2089 | 297 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            8 | Apobaetis | 61 | 3 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            11 | Attenella | 292 | 62 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            12 | Baetis | 3870 | 3445 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            13 | Baetisca | 349 | 66 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            14 | Barbaetis | 1 | 0 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            15 | Brachycercus | 243 | 3 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            16 | Caenis | 3611 | 1221 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            17 | Callibaetis | 758 | 105 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            18 | Caudatella | 194 | 30 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            19 | Centroptilum | 2089 | 297 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            21 | Cinygma | 141 | 2 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            22 | Cinygmula | 726 | 167 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            23 | Cloeon | 7 | 0 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            25 | Dannella | 46 | 55 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|            26 | Dentatella | 3 | 0 | 1,2,4,5,6,8,11,12,13,14,15,16,17,18,19,21,22,23,25,26,27,28,29,<br>31,32,33,34,35,40,41,42,44,45,46,49,51,52,53,58,59,61,<br>66,67,68,69,70,71,72,74,75,76,77,78,80 |
|