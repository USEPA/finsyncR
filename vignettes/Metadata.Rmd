...
#### MinutesShockTime
Description: Actual time (in minutes) that shocking unit is on; the time electricity is being transmitted to the water.
...
Note: This column will only be present when `standardize` is not set to `"none"` in the `getFishData()` function.


```{r example, warning = FALSE, message = FALSE}
# library(StreamData)
# 
# Invertdata = getInvertData(taxonLevel = "Genus",
#                            rarefy = FALSE)
